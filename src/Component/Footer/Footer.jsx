      ...
      <div className='font-paragraph bg-[#F9FAFB]  md:pt-[80px] pt-[64px] md:pb-[60px] w-full' >
        <footer className=" mt-6 md:mt-0 md:max-w-[1170px] w-full text-base font-paragraph mx-auto grid md:grid-cols-3 grid-cols-2 ">
          ...
          <div className='h-[94px] w-full my-auto border-r md:border-0 border-[#D2D6DB]'>
            <Link to='/privacypolicy' className="link link-hover block mb-[11px]">Privacy Policy</Link>
            <Link to="/termsofservice" className="link link-hover nav-text block mb-[11px]">Term of Service</Link>
          ...
          <div className='h-[94px]  w-full flex flex-col items-center my-auto '>
            <div className='text-left'>
              ...
              <Link to='/contact' className="link link-hover nav-text block mb-[11px]">Contact</Link>
              <Link to='/about' className="link mb-7 link-hover nav-text block">Request A Feature</Link>
            </div>
          </div>
