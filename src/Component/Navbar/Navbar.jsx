      ...
      <div className="navbar bg-base-100">
        ...
        <div className="dropdown dropdown-end">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 text-base gap-1 ">
            ...
            <button className="bg-[#2970FF] hover:bg-[#2970FF] rounded-lg text-white hover:text-white text-base">
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 20 22" fill="none">
              ...
              </svg> <span className="my-auto">Login</span></button>
            </li>
          </ul>
        </div>
      </div>
