                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='w-full flex pb-5 mb-5 border-b border-[#EAECF0]'>
                                ...
                                <div className='py-[10px] px-[14px] border rounded-lg h-[44px] w-[512px]'>
                                    <input name='toolName' placeholder="Tool Name" className=' h-full my-auto w-full focus:outline-0 focus:ring-0 outline-0 border-0 focus:border-transparent text-base text-[#101828]' type="text" />
                                </div>
                            </div>
                                ...
                                <div className="w-[400px] border px-[14px] py-[10px] flex flex-wrap gap-2 border-[#D0D5DD] rounded-lg" tabIndex={0} onFocus={() => { inputRef.current.focus() }}>
                                    ...
                                    <div onBlur={setBlur} className={`w-6/12`}>
                                        <div className="relative">
                                            <input placeholder='Choose Sub Category' ref={inputRef} onFocus={setFocus} className={`w-full h-6 focus:border-0 focus:outline-0 focus:ring-0 border-0`} onKeyUp={handleKeyPress} type="text" />
                            ...
                            <div className='w-full flex pb-5 mb-5 border-b border-[#EAECF0]'>
                                ...
                                <div className='py-[10px] px-[14px] border rounded-lg h-[44px] w-[512px] flex items-center'>
                                    ...
                                    <input name='link' placeholder="www.chapple.ai" className='ml-2 mb-[1px] h-full my-auto w-full focus:outline-0 focus:ring-0 border-0  text-base text-[#101828]' type="url" />
                                </div>
                            </div>
                            ...
                            <div className='w-full flex pb-5 mb-5 border-b border-[#EAECF0]'>
                                ...
                                <div className=''>
                                    ...
                                    <div className='mb-4 py-[10px] px-[14px] border rounded-lg h-[44px] w-[512px]' >
                                        <select name='priceType' className='w-full focus:outline-0 focus:ring-0 border-0 text-base font-medium -mt-[10px]'>
                                    ...
                                    <div className='py-[10px] px-[14px] border rounded-lg h-[44px] w-[512px] flex justify-between items-center' >
                                        ...
                                        <div className='w-full flex items-center'>
                                            ...
                                            <input name='price' placeholder="Amount" className='ml-2 mb-[1px] h-full w-full focus:outline-0 text-base text-[#101828] focus:ring-0 border-0' type="text" />
                                        </div>

                                        {/* Price duration */}
                                        <select name='pricePeriod' className='w-3/12 ml-[14px] focus:outline-0 focus:ring-0 border-0 text-base'>
                            ...
                            <div className='w-full flex pb-5 mb-5 border-b border-[#EAECF0]'>
                                ...
                                <div className='py-[10px] px-[14px] border rounded-lg h-[44px] w-[512px] flex items-center'>
                                    ...
                                    <DatePicker
                                        ...
                                        className="focus:outline-0 border-0 focus:ring-0 w-[480px] h-[33px]"
                                        isClearable
                                        showIcon
                                ...
                                <div>
                                    <div className='mb-4 border rounded-lg h-[44px] w-[512px] flex'>
                                        ...
                                        <div className='py-[10px] px-[14px]'>
                                            <input name='facebook' placeholder="Chapple" className=' h-full my-auto w-full focus:outline-0 text-base text-[#101828] focus:ring-0 border-0' type="text" />
                                        </div>
                                    </div>
                                    <div className='mb-4 border rounded-lg h-[44px] w-[512px] flex'>
                                        <div className='w-3/12 py-[10px] px-[14px] border-r text-[#475467] text-base'>
                                        ...
                                        <div className='py-[10px] px-[14px]'>
                                            <input name='linkedin' placeholder="Chapple" className=' h-full my-auto w-full focus:outline-0 text-base text-[#101828] focus:ring-0 border-0' type="text" />
                                        </div>
                                    </div>
                                    <div className='mb-4 border rounded-lg h-[44px] w-[512px] flex'>
                                        <div className='w-3/12 py-[10px] px-[14px] border-r text-[#475467] text-base'>
                                        ...
                                        <div className='py-[10px] px-[14px]'>
                                            <input name='twitter' placeholder="Chapple" className=' h-full my-auto w-full focus:outline-0 text-base text-[#101828] focus:ring-0 border-0' type="text" />
                                        </div>
                                    </div>
                                    <div className=' border rounded-lg h-[44px] w-[512px] flex'>
                                        ...
                                        <div className='py-[10px] px-[14px]'>
                                            <input name='discord' placeholder="Chapple" className=' h-full my-auto w-full focus:outline-0 text-base text-[#101828] focus:ring-0 border-0' type="text" />
                                        </div>
                                    </div>
                                </div>
                            </div>
