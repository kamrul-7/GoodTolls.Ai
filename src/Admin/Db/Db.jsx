                ...
                <div>
                    <div className='quick'>
                        ...
                        <div className='quick-grid'>
                            ...
                            <div className='quick-single item-center'>
                                <div>
                                <svg className='w-12 h-12'  xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
  <path d="M21.3333 18L20.3332 19.094C19.8028 19.6741 19.0835 20 18.3335 20C17.5835 20 16.8642 19.6741 16.3338 19.094C15.8026 18.5151 15.0834 18.1901 14.3336 18.1901C13.5838 18.1901 12.8645 18.5151 12.3333 19.094M3.33337 20H5.00792C5.4971 20 5.74169 20 5.97186 19.9447C6.17594 19.8957 6.37103 19.8149 6.54997 19.7053C6.7518 19.5816 6.92476 19.4086 7.27066 19.0627L19.8334 6.49998C20.6618 5.67156 20.6618 4.32841 19.8334 3.49998C19.005 2.67156 17.6618 2.67156 16.8334 3.49998L4.27063 16.0627C3.92473 16.4086 3.75178 16.5816 3.62809 16.7834C3.51844 16.9624 3.43763 17.1574 3.38863 17.3615C3.33337 17.5917 3.33337 17.8363 3.33337 18.3255V20Z" stroke="#344054" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                </div>
                                <div>
                                <div className='font-bold'>
                            ...
                            <div className='quick-single item-center'>
                                <div>
                                <svg className='w-12 h-12'  xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
  <path d="M12.6666 5V19M5.66663 12H19.6666" stroke="#344054" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                                </div>
                                <div>
