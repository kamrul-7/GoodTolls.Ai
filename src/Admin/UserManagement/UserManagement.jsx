        ...
        <div className='mt-[35px] w-full px-8'>
            <div>
                ...
                <div className='w-full flex items-center justify-between'>
                    ...
                    <button onClick={()=>document.getElementById('my_modal_5').showModal()} className='py-[10px] px-[14px] border rounded-lg bg-[#7F56D9] hover:bg-[#6d4ab8] shadow-sm duration-300 text-white text-sm font-semibold'>
                        Add User
                    </button>
                </div>
                ...
                <table className='border-collapse table-auto w-full mt-[25px] text-[#475467]'>
                    ...
                    <tr className='border-b h-[64px] border-[#EAECF0] text-sm font-medium'>
                        ...
                        <td className='py-4 px-6 hover:bg-[#F9FAFB]'>alma.lawson@example.com</td>
                        <td className='py-4 px-6 hover:bg-[#F9FAFB]'>30/01/2020</td>
                        <td className='py-4 px-6 hover:bg-[#F9FAFB] font-normal'><button className="btn-sm bg-[#ECFDF3] text-xs font-medium text-[#067647] border-2 border-green-200  rounded-3xl px-4">Admin</button></td>
                        {/* Action buttons */}
                        <td className='px-4 py-4 flex items-center justify-center hover:mt-[1px] hover:-mb-[1px] hover:-translate-y-[0.5px] hover:bg-[#F9FAFB]'>
                            ...
                            {/* Edit button */}
                            <button onClick={()=>document.getElementById('my_modal_6').showModal()} className="p-[10px] w-[40px] hover:-translate-y-[0.5px]">
                    ...
                    <tr className='border-b h-[64px] border-[#EAECF0] text-sm font-medium'>
                        ...
                        <td className='py-4 px-6 hover:bg-[#F9FAFB]'>alma.lawson@example.com</td>
                        <td className='py-4 px-6 hover:bg-[#F9FAFB]'>30/01/2020</td>
                        <td className='py-4 px-6 hover:bg-[#F9FAFB] font-normal'><button className="btn-sm bg-[#FEF6EE] border-orange-200 border-2 text-xs font-medium text-[#B93815] rounded-3xl px-4">Content Editor</button></td>
                        {/* Action buttons */}
                        <td className='px-4 py-4 flex items-center justify-center hover:mt-[1px] hover:-mb-[1px] hover:-translate-y-[0.5px] hover:bg-[#F9FAFB]'>
