                ...
                <table className='border-collapse table-auto w-full mt-[25px] text-[#475467]'>
                    ...
                    <tr className='border-b h-[64px] border-[#EAECF0] text-sm font-medium'>
                        ...
                        <td className='px-4 py-4 flex items-center justify-center hover:mt-[1px] hover:-mb-[1px] hover:-translate-y-[0.5px] hover:bg-[#F9FAFB]'>
                            ...
                            {/* Delete button */}
                            <button onClick={() => document.getElementById("my_modal_14").showModal()} className="p-[10px] mr-1 w-[40px] hover:-translate-y-[0.5px]">
                            ...
                            {/* Edit button */}
                            <button  onClick={() => document.getElementById("my_modal_18").showModal()} className="p-[10px] w-[40px] hover:-translate-y-[0.5px]">
...
<rect x="4" y="4" width="48" height="48" rx="24" stroke="#FEF3F2" stroke-width="8"/>
            ...
            <h1 className="py-4 text-lg font-semibold">Delete category</h1>
            <p className="py-4 text-lg font-semibold">Are you sure you want to delete this category? This action cannot be undone.</p>
      <footer className="mt-4 flex justify-end space-x-2">
        <button
          className="btn-circle btn-ghost absolute top-4 right-4 text-2xl"
          type="button"
        ...
        <div className="flex justify-between w-[618px] mx-auto">
          ...
          <button  onClick={() => {
            const modal = document.getElementById("my_modal_14");
            modal.close();
          }} type="submit" className=" w-[48%] my-6 px-4 py-2 bg-[#D92D20] text-white rounded-md">
            Delete
          </button>
        </div>
      </footer>
