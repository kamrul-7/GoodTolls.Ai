            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='w-full flex pb-5 mb-5 border-b border-[#EAECF0]'>
                    ...
                    <div className='py-[10px] px-[14px] border rounded-lg h-[44px] w-[512px]'>
                        <input onChange={handleNameChange} value={toolNameState} name='toolName' placeholder="Chapple" className=' h-full my-auto w-full focus:outline-0 text-base text-[#101828]' type="text" />
                    </div>
                </div>
                ...
                <div className='w-full flex pb-5 mb-5 border-b border-[#EAECF0]'>
                    ...
                    <div className='py-[10px] px-[14px] border rounded-lg h-[44px] w-[512px] flex items-center'>
                        ...
                        <input onChange={handleLinkChange} value={toolLink} name='link' placeholder="www.chapple.ai" className='ml-2 mb-[1px] h-full my-auto w-full focus:outline-0 text-base text-[#101828]' type="url" />
                    </div>
                </div>
                    ...
                    <div className=''>
                        ...
                        <div className='mb-4 py-[10px] px-[14px] border rounded-lg h-[44px] w-[512px]' >
                            <select value={toolPriceType} onChange={handleToolPriceTypeChange}
                             name='priceType' className='w-full focus:outline-0 text-base font-medium'>
                        ...
                        <div className='py-[10px] px-[14px] border rounded-lg h-[44px] w-[512px] flex justify-between items-center' >
                            ...
                            <div className='w-full flex items-center'>
                                ...
                                <input  onChange={handlePriceChange} value={toolPrice} name='price' placeholder="Amount" className='ml-2 mb-[1px] h-full w-full focus:outline-0 text-base text-[#101828]' type="text" />
                            </div>

                            {/* Price duration */}
                            <select value={toolPriceDuration} onChange={handleToolPriceDurationChange} name='pricePeriod' className='w-3/12 ml-[14px] focus:outline-0 text-base'>
                    ...
                    <div>
                        <div className='mb-4 border rounded-lg h-[44px] w-[512px] flex'>
                            ...
                            <div className='py-[10px] px-[14px]'>
                                <input onChange={handleFacebookChange} value={toolFacebook} name='facebook' placeholder="Chapple" className=' h-full my-auto w-full focus:outline-0 text-base text-[#101828]' type="text" />
                            </div>
                        </div>
                        <div className='mb-4 border rounded-lg h-[44px] w-[512px] flex'>
                            <div className='w-3/12 py-[10px] px-[14px] border-r text-[#475467] text-base'>
                            ...
                            <div className='py-[10px] px-[14px]'>
                                <input onChange={handleLinkedinChange} value={toolLinkedin} name='linkedin' placeholder="Chapple" className=' h-full my-auto w-full focus:outline-0 text-base text-[#101828]' type="text" />
                            </div>
                        </div>
                        <div className='mb-4 border rounded-lg h-[44px] w-[512px] flex'>
                            <div className='w-3/12 py-[10px] px-[14px] border-r text-[#475467] text-base'>
                            ...
                            <div className='py-[10px] px-[14px]'>
                                <input onChange={handleTwitterChange} value={toolTwitter} name='twitter' placeholder="Chapple" className=' h-full my-auto w-full focus:outline-0 text-base text-[#101828]' type="text" />
                            </div>
                        </div>
                        <div className=' border rounded-lg h-[44px] w-[512px] flex'>
                            ...
                            <div className='py-[10px] px-[14px]'>
                                <input onChange={handleDiscordChange} value={toolDiscord} name='discord' placeholder="Chapple" className=' h-full my-auto w-full focus:outline-0 text-base text-[#101828]' type="text" />
                            </div>
                        </div>
                    </div>
                </div>
