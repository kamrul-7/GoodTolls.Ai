...
<div className='flex items-center mt[34px] my-4 ml-2'>
                 ...
                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                     ...
                     <defs>
                     <clipPath id="clip0_810_9466">                             <rect width="20" height="20" fill="white" transform="translate(0 0.5)" />
                        </clipPath>
                    </defs>
               </svg>
                 <p>News</p>
...
<div className=' grid  md:grid-cols-2 gap-12 mt-2 mx-auto mr-4 pr-12'>
{
                    isLoading ? 
