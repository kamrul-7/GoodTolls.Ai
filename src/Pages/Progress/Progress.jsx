...
const Progress = ({rating, val}) => {
    return (
        <div className="flex items-center justify-between text-xl leading-[30px] mb-3">
            <div className="flex items-center justify-between md:justify-normal w-[42px] md:w-fit"><span>{rating}</span>
            ...
            <progress className="progress progress-warning  md:w-[332px] w-7/12" value={val} max="100"></progress>
            <span className="md:w-[55px] w-[51px]">{val}%</span>
        </div>
    );
};
