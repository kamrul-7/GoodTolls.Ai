...
const Progress = ({rating, val}) => {
    return (
        <div className="flex items-center justify-between text-xl leading-[30px] mb-3">
            ...
            <svg className="ml-4" width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <progress className="progress progress-warning  w-[332px]" value={val} max="100"></progress>
            <span className="w-[55px]">{val}%</span>
        </div>
    );
};
